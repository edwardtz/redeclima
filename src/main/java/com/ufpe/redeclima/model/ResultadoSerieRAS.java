 ...
 */
@Entity
@Table(name="t_resultado_serie_ras")
public class ResultadoSerieRAS implements Serializable{
...
private static final long serialVersionUID = 1L;
	...
	private SimulacaoSerie simulacao;
	...
	public SimulacaoSerie getSimulacao() {
		return simulacao;
	}

	public void setSimulacao(SimulacaoSerie simulacao) {
