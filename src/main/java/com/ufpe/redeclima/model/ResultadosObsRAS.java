 ...
 */
@Entity
@Table(name="t_resultados_obs_ras")
public class ResultadosObsRAS implements Serializable {
	...
	private SimulacaoObs simulacao;
	...
	public SimulacaoObs getSimulacao() {
		return simulacao;
	}

	public void setSimulacao(SimulacaoObs simulacao) {
