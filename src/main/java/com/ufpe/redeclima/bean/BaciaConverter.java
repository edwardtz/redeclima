...
public class BaciaConverter implements Converter{
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		return baciaDao.findById(getId(value));
	}
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		if (value instanceof Bacia) {
            Bacia b = (Bacia) value;
            return Long.toString(b.getId());
        } else {
            throw new IllegalArgumentException("Objeto " + value + " possui o tipo " + value.getClass().getName() + "; tipo esperado: " + Bacia.class.getName());
        }
