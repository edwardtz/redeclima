...
public class GradeConverter implements Converter{
	...
	public Object getAsObject(FacesContext arg0, UIComponent arg1, String value) {
		return gradeDao.findById(getId(value));
	}
	...
	public String getAsString(FacesContext arg0, UIComponent arg1, Object object) {
        ...
        if (object instanceof Grade) {
            Grade p = (Grade) object;
            return Long.toString(p.getId());
        } else {
            throw new IllegalArgumentException("objeto " + object + " possui o tipo " + object.getClass().getName() + "; tipo esperado: " + Grade.class.getName());
        }
