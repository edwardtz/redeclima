...
public class TrechoConverter implements Converter {
	...
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		...
		return trechoDao.findById(Long.valueOf(value));
	}
	...
	public String getAsString(FacesContext context, UIComponent component, Object value) {
		...
		if (value instanceof Trecho) {
            Trecho b = (Trecho) value;
            return Long.toString(b.getId());
        } else {
            throw new IllegalArgumentException("Objeto " + value + " possui o tipo " + value.getClass().getName() + "; tipo esperado: " + Trecho.class.getName());
        }
