...
/**
 * @author edwardtz
 * Enumera os possíveis tipos de dados usados na simulação dos modelos
 */
public enum EnumTipoDados {

	PREVISAO(1, "Previsão"),
	OBSERVACAO(2, "Obervação");
	
	private int id;
	
	private String descripcao;
	
	EnumTipoDados(int id, String descripcao){
		this.id=id;
	...
	public static EnumTipoDados getById(int id){
		return values()[id];
	}
}
